...
drop policy if exists "Products selectable by anyone" on public.products;
create policy "Products selectable by anyone" on public.products
...
drop policy if exists "Plans selectable by anyone" on public.plans;
create policy "Plans selectable by anyone" on public.plans
for select using (true);
...
create policy "Users can update their own licenses" on public.licenses
...
drop policy if exists "Users can view their device activations" on public.device_activations;
create policy "Users can view their device activations" on public.device_activations
for select using (
  exists (
...
drop policy if exists "Users can insert their device activations" on public.device_activations;
create policy "Users can insert their device activations" on public.device_activations
...
drop policy if exists "Users can update their device activations" on public.device_activations;
create policy "Users can update their device activations" on public.device_activations
for update using (
  exists (
    select 1 from public.licenses l where l.id = license_id and l.owner_id = auth.uid()
  )
